...
//  
//  moc_scanningdialog.cpp -- template and derived ESC/I ESC/I-2 protocol commands
...
QT_MOC_LITERAL(3, 23, 6)
    ...
    "ScanningDialog\0Update\0\0Cancel"
};
...
void ScanningDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ScanningDialog *_t = static_cast<ScanningDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ScanningDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ScanningDialog.data,
      qt_meta_data_ScanningDialog, qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScanningDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScanningDialog.stringdata0))
        return static_cast<void*>(const_cast< ScanningDialog*>(this));
