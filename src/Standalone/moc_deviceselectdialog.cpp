...
//  
//  moc_deviceselectdialog.cpp -- template and derived ESC/I ESC/I-2 protocol commands
...
QT_MOC_LITERAL(4, 41, 15)
    ...
    "DeviceSelectDialog\0onValueChanged\0\0"
    "value\0PushEventButton"
};
...
void DeviceSelectDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DeviceSelectDialog *_t = static_cast<DeviceSelectDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onValueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->PushEventButton(); break;
        default: ;
        }
    }
}
const QMetaObject DeviceSelectDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DeviceSelectDialog.data,
      qt_meta_data_DeviceSelectDialog, qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DeviceSelectDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DeviceSelectDialog.stringdata0))
        return static_cast<void*>(const_cast< DeviceSelectDialog*>(this));
